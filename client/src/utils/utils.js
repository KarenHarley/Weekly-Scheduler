...
const unformatTime = (time) => {
  //if there is no number after : also its in the am
  if (time.split(":")[1] === "00 am") {
    return time.split(":")[0];
  }
  //if there is "15" after : also its in the am
  if (time.split(":")[1] === "15 am") {
    return time.split(":")[0] + ".2";
  }
  //if there is "30" after : also its in the am
  if (time.split(":")[1] === "30 am") {
    return time.split(":")[0] + ".5";
  }
  //if there is "45" after : also its in the am
  if (time.split(":")[1] === "45 am") {
    return time.split(":")[0] + ".7";
  }
  //if there is "00" after : also its in the pm
  if (time.split(":")[1] === "00 pm") {
    return parseInt(time.split(":")[0]) + 12;
  }
  //if there is "15" after : also its in the pm
  if (time.split(":")[1] === "15 pm") {
    return parseInt(time.split(":")[0]) + 12.2;
  }
  //if there is "30" after : also its in the pm
  if (time.split(":")[1] === "30 pm") {
    return parseInt(time.split(":")[0]) + 12.5;
  }
  //if there is "45" after : also its in the pm
  if (time.split(":")[1] === "45 pm") {
